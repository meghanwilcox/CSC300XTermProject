document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const category = "Coffee"; // Set the category you want to retrieve products for
        ...
        if (response.ok) {
            ...
            console.error('Error retrieving products coffee:', response.statusText);
        }
    } catch (error) {
        console.error('Error retrieving products coffee:', error);
    }
